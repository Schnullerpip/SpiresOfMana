...
public class RFX4_DistortionAndBloom : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        {
            if (UseBloom && destination!=null) Graphics.DrawTexture(new Rect(0, 0, Screen.width, Screen.height), destination, matAdditive);
        }
    }
    ...
    void UpdateCameraCopy()
    {
        ...
        if (cam != null)
        {
            ...
            {
                if (source != null) source.DiscardContents();
