...
//		);
	...
	public class SpellSlot {
        ...
        public void Resolve(PlayerScript caster)
        {
            ...
            //Debug.Log("castDurationCount" + caster.castStateSystem.current.GetCastDurationCount()*1000);

            if (caster.castStateSystem.current.GetCastDurationCount()*1000 > spell.castDurationInSeconds)
            {
