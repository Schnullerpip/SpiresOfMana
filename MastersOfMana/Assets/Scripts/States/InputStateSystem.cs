...
public class InputStateSystem
{
	...
	/// </summary>
    public enum InputStateID {Normal, Hurt, Idle, Paralyzed, Dead, Lobby, NoMovement, NoCasting};
    ...
    public InputStateSystem(PlayerScript player)
    {
        ...
        states = new List<A_InputState>()
        {
            ...
            new InputStateDead(player),
            new InputStateLobby(player),
            new InputStateNoMovement(player),
            new InputStateNoCasting(player)
        };
