    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 node_8211 = (i.uv0+float2((sin(node_8998)*_amplitude),(sin((node_8998+_offset))*_amplitude))+(node_9303.b*_Turbulance_var.r));
